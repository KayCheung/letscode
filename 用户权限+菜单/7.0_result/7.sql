...
INSERT INTO presentation (PRSNTTN_ID,FRAME_ID,URL,ONCLICK,PRSNTTN_LABEL,PRSNTTN_LABEL2,
        ...
        PRSNTTTN_ALLOW_USERCLASS,PRSNTTN_GROUP_ID,EXCLUDED_COPERMISSIONS) 
        VALUES  
        ('VisPro_Diameter_Alarm_Pod_View_userP_prsn',null,null,null,'Alarm Pod View',null,
...
INSERT INTO resourc (RSRC_ID,RSRC_NAME,RSRC_DESC,RSRC_TYP_CD,CMPNY_TYP_CD,RSRC_REQ_HRCHY_CD,
	...
	PROD_MENU_CATEGORY, PRESENTATION_ORDER,RSRC_GROUPTYPE,RESTRICT_GRANT,ACC_ENV_SUFFIX,CO_PERM_CHECKED_FOR_CO,IS_LIVE) 
	values 
	('VisPro_Diameter_Alarm_Pod_View_userP', 'VisPro_Diameter_Alarm_Pod_View_userP', null, '2', 'Unassigned', 
	null, 'VisPro_Diameter_Alarm_Pod_View_userP_prsn', null, null, 
	null, null, null, null, 
	null, null, null, null, null, 
	systimestamp, systimestamp, 'cn=directory manager', 'uid=xroads,o=crossroads', null, 
	null, null, null, null, 
...
Insert into RSRC_TO_RSRC_REL (RSRC_ID1,RSRC_ID2,REL_TYP_CD,CREATED_DT,MODIFIED_DT,
	CREATED_BY,MODIFIED_BY, RSRC_TYP_CD) 
	values 
	('VisPro_Diameter_Alarm_Pod_View_userP','VisPro_Diameter_cmpyP','Copermission',systimestamp,systimestamp,
	'cn=directory manager','cn=directory manager','2');
Insert into RSRC_TO_RSRC_REL (RSRC_ID1,RSRC_ID2,REL_TYP_CD,CREATED_DT,MODIFIED_DT,
	CREATED_BY,MODIFIED_BY, RSRC_TYP_CD) 
	values 
	('VisPro_Diameter_Alarm_Pod_View_userP','VisSvc','Product',systimestamp,systimestamp,
	'cn=directory manager','cn=directory manager','2');
Insert into RSRC_TO_RSRC_REL (RSRC_ID1,RSRC_ID2,REL_TYP_CD,CREATED_DT,MODIFIED_DT,
	CREATED_BY,MODIFIED_BY, RSRC_TYP_CD) 
	values 
	('VisPro_Diameter_Alarm_Pod_View_userP','VisPro','Implied',systimestamp,systimestamp,
	'cn=directory manager','cn=directory manager','2');
Insert into RSRC_TO_RSRC_REL (RSRC_ID1,RSRC_ID2,REL_TYP_CD,CREATED_DT,MODIFIED_DT,
	CREATED_BY,MODIFIED_BY, RSRC_TYP_CD) 
	values 
	('VisPro_Diameter_Alarm_Pod_View_userP','VisPro_Vis','Implied',systimestamp,systimestamp,
	'cn=directory manager','cn=directory manager','2');
Insert into RSRC_TO_RSRC_REL (RSRC_ID1,RSRC_ID2,REL_TYP_CD,CREATED_DT,MODIFIED_DT,
	CREATED_BY,MODIFIED_BY, RSRC_TYP_CD) 
	values 
	('VisPro_Diameter_Alarm_Pod_View_userP','VisPro_Diameter_userP','PermissionGroup',systimestamp,systimestamp,
	'cn=directory manager','cn=directory manager','2');
-- ######################################
...
-- ######################################
-- dn: uid=VisPro_Diameter_Alarm_Pod_menuitem_prsn, ou=PresentationObjects,o=Crossroads
-- ######################################
INSERT INTO presentation (PRSNTTN_ID,FRAME_ID,URL,ONCLICK,PRSNTTN_LABEL,PRSNTTN_LABEL2,
	PRSNTTN_LABEL_TAG,PRSNTTN_LABEL_POS,PRSNTTN_ORDER,PRSNTTN_RESTRICT,PRSNTTN_CHK_BX_GRP, PRSNTTN_POS,
	PRSNTTN_COL_HEADING,PRSNTTN_COL_WIDTH,PRSNTTN_ACC_TAG,PRSNTTN_HTML_ATTR,PRSNTTN_RADIO_GRP,PRSNTTN_RADIO_BUTTON,
	...
	PRSNTTTN_ALLOW_USERCLASS,PRSNTTN_GROUP_ID,EXCLUDED_COPERMISSIONS) 
	VALUES  
	('VisPro_Diameter_Alarm_Pod_menuitem_prsn','NEW_TAB','https://vis-diameter-portal-dev.syniverse.com/visproGUI/alert/index.html','parent.NavFrame.openWindow(''https://vis-diameter-portal-dev.syniverse.com/visproGUI/alert/index.html'',''AlarmPod'',''Alarm%20Pod'')','Alarm Pod',null,
	'4413',null,'0010',null,null,
	null,null,null,null,null,
	null,null,null,systimestamp,systimestamp,
	'cn=directory manager','uid=xroads,o=crossroads',null,'menuitem',null,
	'VisPro_Diameter_Alarm_Pod_View_userP', null,null,null,
	null,null,null,null );
INSERT INTO resourc (RSRC_ID,RSRC_NAME,RSRC_DESC,RSRC_TYP_CD,CMPNY_TYP_CD,RSRC_REQ_HRCHY_CD,PRSNTTN_ID,
	RSRC_OWNER,RSRC_UNRESTRICTED_ACC,RSRC_RESTRICTED,RSRC_UNRESTRICTED, RSRC_HELP_URL,RSRC_HOST,RSRC_HOME_PAGE,RSRC_MAIL,
	RSRC_FULL_PATH,RSRC_PORTAL,RSRC_SUBJECT_AREA,CREATED_DT,MODIFY_DT,CREATED_BY,MODIFY_BY,PROD_MENU_CATEGORY, PRESENTATION_ORDER,
	RSRC_GROUPTYPE,RESTRICT_GRANT,ACC_ENV_SUFFIX,CO_PERM_CHECKED_FOR_CO,IS_LIVE) 
	values 
	('VisPro_Diameter_Alarm_Pod_menuitem', 'VisPro_Diameter_Alarm_Pod_menuitem', null, '4', null, 
	null, 'VisPro_Diameter_Alarm_Pod_menuitem_prsn', null, null, 
	null, null, null, null, 
	null, null, null, null, null, 
	systimestamp, systimestamp, 'cn=directory manager', 'uid=xroads,o=crossroads', null, 
	null, null, null, null, 
...
Insert into RSRC_TO_RSRC_REL (RSRC_ID1,RSRC_ID2,REL_TYP_CD,CREATED_DT,MODIFIED_DT,
	CREATED_BY,MODIFIED_BY,RSRC_TYP_CD) 
	values 
	('VisPro_Diameter_Alarm_Pod_menuitem','VisPro_Diameter_Menu_prsn','PresGroup',systimestamp,systimestamp,
	'cn=directory manager','cn=directory manager','4');
-- ######################################
...
INSERT INTO presentation (PRSNTTN_ID,FRAME_ID,URL,ONCLICK,PRSNTTN_LABEL,PRSNTTN_LABEL2,
	...
	PRSNTTTN_ALLOW_USERCLASS,PRSNTTN_GROUP_ID,EXCLUDED_COPERMISSIONS) 
	VALUES  
	('VisPro_Diameter_Heat_Map_Pod_menuitem_prsn','NEW_TAB','https://vis-diameter-portal-dev.syniverse.com/visproGUI/diameterHeatmap/index.html', 'parent.NavFrame.openWindow(''https://vis-diameter-portal-dev.syniverse.com/visproGUI/diameterHeatmap/index.html'',''HeatMapPod'',''Heat%20Map%20Pod'')','Heat Map Pod',null,
