...
INTO XROADS_OWNER.presentation
  ...
  VALUES
  (
    'VisProactive_Diameter_Heat_Map_Pod',--PRSNTTN_ID
    'NEW_TAB',
    'http://10.28.121.41:9090/crossroad_sample/',
    'parent.NavFrame.openWindow(''http://10.28.121.41:9090/crossroad_sample/'',''Heat Map Pod''+parent.NavFrame.sUIDParam)',
    'Heat Map Pod',
    NULL,
    'HEAT_MAP_POD',
    NULL,
